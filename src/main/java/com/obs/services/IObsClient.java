...
public interface IObsClient {
     ...
     *
     * @param request Parameters in a request for temporarily authorized access
     ...
     *
     * @param request Request parameters for V4 browser-based authorized access
     ...
     * </ul>
     *
     * @param bucket Bucket information, including the request parameters
     * @return Bucket information
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param request Obtain the request parameters for obtaining the bucket list.
     * @return Bucket list
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param request Request parameters for listing objects in a bucket
     ...
     *
     * @param request Request parameters for listing versioning objects in the bucket
     ...
     *
     * @param bucketName      Bucket name
     * @param prefix          Object name prefix used for listing versioning objects
     * @param delimiter       Character for grouping object names
     * @param keyMarker       Start position for listing versioning objects (sorted by object name)
     * @param versionIdMarker Start position for listing versioning objects (sorted by version ID)
     * @param maxKeys         Maximum number of versioning objects to be listed
     * @return Response to the request for listing versioning objects in the bucket
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param request Request parameters for obtaining bucket metadata
     ...
     *
     * @param bucketName    Bucket name
     * @param bucketStorage Bucket storage policy
     * @return Common response headers
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param bucketName           Bucket name
     * @param loggingConfiguration Logging settings
     * @return Common response headers
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param bucketName              Bucket name
     * @param versioningConfiguration Versioning status of the bucket
     * @return Common response headers
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param bucketName      Bucket name
     * @param lifecycleConfig Bucket lifecycle rules
     * @return Common response headers
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param bucketName Bucket name
     * @param policy     Bucket policy, in the JSON format
     * @return Common response headers
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param bucketName    Bucket name
     * @param websiteConfig Website hosting configuration of a bucket
     * @return Common response headers
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param bucketName    Bucket name
     * @param bucketTagInfo Bucket tags
     * @return Common response headers
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param bucketName       Bucket name
     * @param bucketEncryption Bucket encryption configuration
     * @return Common response headers
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param bucketName               Bucket name
     * @param replicationConfiguration Cross-region replication configuration
     * @return Common response headers
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param bucketName                      Bucket name
     * @param bucketNotificationConfiguration Bucket notification configuration
     * @return Common response headers
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     * Upload an object.
     *
     * @param request Parameters in an object upload request
     * @return Response to an object upload request
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param uploadFileRequest Parameters in a file upload request
     ...
     *
     * @param downloadFileRequest Parameters in a request for downloading a file
     ...
     * Download an object.
     *
     * @param request Parameters in an object download request
     ...
     *
     * @param request Parameters in a request for obtaining the properties of an object
     ...
     *
     * @param request Parameters in a request for restoring an Archive object
     ...
     * Restore an Archive object.
     *
     * @param request Request parameters for restoring an Archive object
     ...
     *
     * @param request Request parameters for restoring Archive objects in a batch
     ...
     *
     * @param deleteObjectsRequest Parameters in an object batch deletion request
     ...
     * Copy an object.
     *
     * @param request Parameters in a request for copying an object
     ...
     * @param destObjectKey    Destination object name
     * @return Result of the object copy
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     *
     * @param request Parameters in a request for initializing a multipart upload
     ...
     * Upload a part.
     *
     * @param request Parameters in a part upload request
     * @return Response to a part upload request
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     * Copy a part.
     *
     * @param request Parameters in the request for copying a part
     ...
     * Combine parts.
     *
     * @param request Parameters in a request for combining parts
     * @return Result of part combination
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     */
     ...
     * List uploaded parts.
     *
     * @param request Parameters in a request for listing uploaded parts
     ...
     *
     * @param request Parameters in a request for listing multipart uploads
