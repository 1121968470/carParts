 ...
 * Include a set of permissions ({@link Permission}) authorized to specified grantee ({@link GranteeInterface}).
 */
public class AccessControlList extends HeaderResponse {
    ...
    /**
     * Obtain the permission specified in the ACL {@link GranteeInterface}.
     *
     * @param grantee Authorized user
     * @return Permission list of {@link GranteeInterface}
     */
    ...
    /**
     * Specify permissions {@link Permission} in the ACL {@link GranteeInterface}.
     *
     * @param grantee    Authorized user
     * @param permission Permissions defined in {@link Permission}
