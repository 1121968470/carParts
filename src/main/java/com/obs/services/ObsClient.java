...
public class ObsClient extends ObsService implements Closeable, IObsClient, IFSClient {
     ...
     * @param objectKey    Object name
     * @param specialParam Special operator
     * @param expires      Time when the temporary authentication expires. The unit is second and the default value is 300.
     * @param headers      Header information
     * @param queryParams  Query parameter information
     * @return Temporarily authorized URL
     * @throws ObsException OBS SDK self-defined exception, thrown when the interface fails to be called or access to OBS fails
     ...
     * @param nextVersionIdMarker Deprecated field
     ...
     *
     * @param bucketName Bucket name
     * @param cannedACL  Pre-defined access control policy
     * @param acl        ACL ("acl" and "cannedACL" cannot be used together.)
     ...
     *
     * @param bucketName Bucket name
     * @param optionInfo Parameters in a bucket preflight request
     ...
     * @param bucketName Bucket name
     * @param objectKey  Object name
     * @param optionInfo Parameters in an object preflight request
