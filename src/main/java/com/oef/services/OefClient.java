...
public class OefClient extends ObsClient implements IOefClient {
     ...
     * Constructor
     *
     * @param endPoint OEF service address
     */
     ...
     * Constructor
     *
     * @param config Configuration parameters of OEF client
     */
     ...
     * Constructor
     *
     * @param accessKey     AK in the temporary access keys
     * @param secretKey     SK in the temporary access keys
